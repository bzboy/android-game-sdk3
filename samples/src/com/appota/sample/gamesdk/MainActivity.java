...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //init sdk
        sdk = AppotaGameSDK.getInstance().init(this, "http://pay.thienha.mobi/YNGameSDK/Googleplay.html", true, "http://filestore9.com/test.php", apiKey, sandboxApiKey);

        //optional
        sdk.setShowButtonType(AppotaGameSDK.SHOW_ACCOUNT_BUTTON);

        //show or hide switch, logout button
        sdk.setShowUserFunctionButtons(true);
